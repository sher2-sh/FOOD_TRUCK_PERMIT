...
#Update vendor +1 per food founds in food_items
...
for cluster in range(K):
    ...
    cluster_representatives[cluster] = [item for item, _ in food_counts.most_common(10)] # Pick 10 most count to store into cluster.
...
for cluster in range(K):
 ...
 # Get lists from top lists
    ...
    if cleaned_foods:
        ...
        print(f"No significant food items found")
        
#Clusters Scatter plot showing the Total amount a vendor sell include what they sell in the cluster.
...
plt.xlabel('How many different food a vendors sell')
